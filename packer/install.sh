...
wget -q https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.5.2-amd64.deb
wget -q https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.5.2-amd64.deb.sha512
